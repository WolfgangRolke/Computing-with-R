---
title: Data Formats - Vectors, Matrices, Arrays, Data frames and Lists
...
In this case R just starts all over again. This behaviour is called *recycling* (in computer sciecne, not just R)
...
There is a strange default behaviour of data frames: they turn strings into factors:
...
Anything can be an element of a list:
