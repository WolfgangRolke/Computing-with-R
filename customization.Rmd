...
options(help_type="html")  #ignored in RStudio
...
-  keep things consistent: I have a number of computers, I don't want to have to work on keeping them synchronized. When I change a file in a Drpbox folder on one computer and then go to another, as soon as the new file is downleaded I got it there as well.   
