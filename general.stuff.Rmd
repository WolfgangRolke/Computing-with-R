...
Changing one or more of these options is something one needs to do on occasion inside a function. If so you likely want to reset them to the defaults before leaving the function:
...
Many times your google search will lead you to [stackoverflow](https://stackoverflow.com). This is a website for people working on computer coding problems to help each other. It is not specific to R but the R community is using to discuss and solve R questions. 
...
-  did you really try hard enough to find an answer on your own? It is very embarrasing when you post a question and the reply is a link to a simple google search that has the answer already. 
