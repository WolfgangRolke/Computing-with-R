...
Personally I prefer to also have a distinct name for the Rdata worksheet. You can do that by running
...
It is good practice to have a consistent style when choosing names for oblects, functions etc. There is a detailed description at [https://google.github.io/styleguide/Rguide.xml](https://google.github.io/styleguide/Rguide.xml). Here are the most important ones:
...
function names have initial capital letters and no dots.  Make function names verbs.         
