...
-  filter()  select part of a data set by conditions (base R command: subset)
-  select() 	select columns  (base R command: [ ])
-  arrange() 	re-order or arrange rows  (base R commands: sort, order)
-  mutate() 	create new columns  (base R commands: any math function)
-  summarise() 	summarise values  (base R commands: mean, median etc)
