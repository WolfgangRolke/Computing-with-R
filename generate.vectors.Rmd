...
This calculates the outer product of two vectors. It creates a matrix of length(x) x length(y) where $z_{ij} = f(x_i, y_j)$ for some fnction $f$
...
Want to practise you multiplication?
